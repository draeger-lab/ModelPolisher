...
public interface IOOptions extends KeyProvider {
  ...
  /**
   * Specifies the SBML or MAT input file. If a directory is given, the conversion
   * will be recursively performed. MAT files will be converted to SBML prior to
   * polishing.
   */
  public static final Option<File> INPUT = new Option<File>(
      "INPUT", File.class, "Input SBML file",
      new Range<File>(File.class, new MultipleFileFilter("SBML or MAT files, or directories",
   ...
   */
  public static final Option<File> OUTPUT = new Option<File>(
      "OUTPUT", File.class, "Output SBML file",
      new Range<File>(File.class, new MultipleFileFilter("SBML",
        SBFileFilter.createSBMLFileFilter(),
        SBFileFilter.createDirectoryFilter())));
