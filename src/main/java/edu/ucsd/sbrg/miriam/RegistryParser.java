...
public class RegistryParser {
  ...
  private static InputStream registryStream;

  private RegistryParser() {
    super();
    registryStream = RegistryParser.class.getResourceAsStream("IdentifiersOrg-Registry.json");
  }
  ...
  Miriam parse() throws IOException {
    ...
    Root root =  mapper.readValue(registryStream, Root.class);
