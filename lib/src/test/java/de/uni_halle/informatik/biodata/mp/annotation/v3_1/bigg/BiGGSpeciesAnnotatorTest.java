package de.uni_halle.informatik.biodata.mp.annotation.v3_1.bigg;
...
import de.uni_halle.informatik.biodata.mp.polishing.v3_1.ReactionsPolisherTest;
...
public class BiGGSpeciesAnnotatorTest extends BiGGDBContainerTest {
    ...
    private SBMLDocument modelDuplicateIds() throws ModelReaderException {
        return new ModelReader(sboParameters, new IdentifiersOrg()).read(
                new File(ReactionsPolisherTest.class.getClassLoader().getResource("de/uni_halle/informatik/biodata/mp/models/duplicateIds.xml").getFile()));
    }
...
//
//    @Test
//    public void dups() throws SQLException, ModelReaderException {
//        var doc = modelDuplicateIds();
//        var m = doc.getModel();
//
//        var s = doc.getModel().getSpecies("id1");
//        assertEquals("m2", s.getMetaId());
//    }
