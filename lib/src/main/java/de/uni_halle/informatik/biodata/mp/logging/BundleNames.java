...
public class BundleNames {
    ...
    public static final String FIXING_MESSAGES = "de.uni_halle.informatik.biodata.mp.fixing.Messages";
    public static final String IO_MESSAGES = "de.uni_halle.informatik.biodata.mp.io.Messages";
