...
function check_md5sum() {
    WORKDIR=$(pwd)
    cd ../src/main/resources/edu/ucsd/sbrg/bigg/
...
cp bigg.zip.md5 ../src/main/resources/edu/ucsd/sbrg/bigg/

# check if db exists and is valid
if [ ! -f ../src/main/resources/edu/ucsd/sbrg/bigg/bigg.zip ] ||  check_md5sum; then
    ...
    if [ -f ../src/main/resources/edu/ucsd/sbrg/bigg/bigg.zip.md5 ]; then
        rm ../src/main/resources/edu/ucsd/sbrg/bigg/bigg.zip.md5
    fi
    if [ ${counter} -eq 4 ]; then
        echo "Failed to verify integrity of bigg.zip, aborting"
        exit 2
    fi
    mv bigg.zip ../src/main/resources/edu/ucsd/sbrg/bigg/
fi

unzip -od ../src/main/resources/edu/ucsd/sbrg/bigg ../src/main/resources/edu/ucsd/sbrg/bigg/bigg.zip
